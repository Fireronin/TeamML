...
file4 = '../stats/4_accuracy_per_percent.csv'
...
df4.rename(columns = {'column_0' : 'Accuracy'}, inplace = True)
...
df1['Accuracy_transformer'] = df4['Accuracy']
...
ax.plot(x, df1['Accuracy_transformer'], label='Transformer')
...
fig.add_trace(go.Scatter(x=x, y=df1['Accuracy_transformer'], name='Transformer'))
